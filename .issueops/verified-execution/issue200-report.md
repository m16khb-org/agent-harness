...
- 이슈: https://github.com/m16khb-org/issueops/issues/200
...
- draft PR: https://github.com/m16khb-org/issueops/pull/219
...
- `codex app-server --enable hooks --stdio`의 `hooks/list`가
  `./bin/issueops hook pre-tool-use ...`를 enabled hook으로 반환했다.
...
Evidence artifact: `.issueops/verified-execution/issue200-report.md`, final architecture
...
`/Users/m16khb/.Trash/issueops-issue200-proof.OrZ4QA`로 이동했다. Isolated
host homes, state fixtures, schema와 import captures는
`/Users/m16khb/.Trash/issueops-issue200-temp.nnFDY7`로 이동했다. 모두
