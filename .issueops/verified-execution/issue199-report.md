...
- 이슈: https://github.com/m16khb-org/issueops/issues/199
...
- draft PR: [#218](https://github.com/m16khb-org/issueops/pull/218)
- 초기 원격 CI: [run 30722218325](https://github.com/m16khb-org/issueops/actions/runs/30722218325) 성공

## 결과

IssueOps execution의 `prepare` action을
`contract/domain/application/inbound/outbound` 수직 경계로 이전했다.
`cmd/issueops/issueopsapp`만 Git worktree, Orca, provider issue snapshot과
...
| AC-199-08 | PASS | CLI/MCP production wiring은 issueopsapp의 단일 handler를 사용하고 nil handler는 `issueops execution prepare handler is not configured`로 fail-closed한다. Production legacy prepare caller와 fallback slot은 0이다. |
...
issueopsapp이 요청마다 composition deps를 복사해 reader만 교체하도록 수정했다.
...
`cmd/issueops/issueopsapp/issueops_preparation_hook_wiring_test.go`는 두 host의
...
go test ./cmd/issueops/issueopscli ./cmd/issueops/issueopscli/executioncmd ./cmd/issueops/mcpcli ./cmd/issueops/issueopsapp -run 'ExecutionPrepare|Prepare|ExecutionHandler|ResponseContract' -count=1
go test ./internal/core/lifecycle ./cmd/issueops/hookcli -run 'AtomicPreflight|Canonical|Workdir|OwnerMutation|ExecutionPrepare' -count=1
go test -race ./internal/core/lifecycle ./cmd/issueops/hookcli -count=1
...
go vet ./internal/contract/issueopspreparation/... ./internal/domain/issueopspreparation/... ./internal/application/issueopspreparation/... ./internal/adapter/inbound/issueopspreparation/... ./internal/adapter/outbound/issueopspreparation/... ./internal/core/issueops ./cmd/issueops/issueopscli/... ./cmd/issueops/mcpcli/... ./cmd/issueops/issueopsapp/...
go build -o bin/issueops ./cmd/issueops
git diff --check 739de96aeca540cf7d5cf6333b345a192afcfd59...HEAD
go test ./... -count=1
./bin/issueops self-verify --seed=100 --target-score=95 --llm-eval=false --progress=jsonl --save-state --state-key self-verify-199-quick --json
  result: 25/25, minimum_goal_score=100, coverage_gaps=[]
./bin/issueops self-verify --full --iterations=10 --seed=100 --target-score=95 --llm-eval=false --progress=jsonl --save-state --state-key self-verify-199-full --json
...
```text
cmd/issueops/issueopsapp/issueops_policy_facade.go
cmd/issueops/issueopsapp/issueops_preparation_hook_wiring_test.go
cmd/issueops/issueopsapp/issueops_preparation_wiring.go
cmd/issueops/issueopsapp/issueops_preparation_wiring_test.go
cmd/issueops/issueopsapp/issueops_reconcile_wiring_test.go
cmd/issueops/issueopsapp/mcp_facade.go
cmd/issueops/issueopscli/executioncmd/execution.go
cmd/issueops/issueopscli/executioncmd/snapshot_file_test.go
cmd/issueops/issueopscli/exports.go
cmd/issueops/issueopscli/issueops_execution_cli.go
cmd/issueops/issueopscli/issueops_execution_cli_test.go
cmd/issueops/mcpcli/mcp_tool_issueops_execution.go
...
Evidence artifact: `.issueops/verified-execution/issue199-report.md`, PR #218,
...
`/Users/m16khb/.Trash/issueops-hook-smoke.qLi626`로, reviewer가 만든
