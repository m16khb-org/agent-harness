...
- 이슈: https://github.com/m16khb-org/issueops/issues/117
...
- `codex app-server --enable hooks --stdio`의 `hooks/list`는 source
  `/private/tmp/issueops-issue117-proof.Mle92Z/codex-home/hooks.json`,
...
```text
./bin/issueops self-verify --full --iterations=10 --seed=100 \
...
Evidence artifact: `.issueops/verified-execution/issue117-report.md`, finalization plan,
...
`/Users/m16khb/.Trash/issueops-issue117-proof-20260802-1123`으로 이동했다.
