...
이슈: https://github.com/m16khb-org/issueops/issues/153
사이클: io-66c28415cf2b
...
`execution complete`가 검증 보고서를 요구하는 시점이 PR 머지 이후일 수 있으므로, 그
...
> ancestry 검사는 squash 머지에서 부적합하므로 OID CAS만 쓴다(design-review B3).
