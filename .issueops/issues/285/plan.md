...
issue: "https://github.com/m16khb-org/issueops/issues/285"
...
worktree: "/Users/m16khb/Workspace/issueops.worktrees/285-cleanup-status-finish-parity"
...
- `cmd/issueops/issueopscli/issueops_cleanup_cli_test.go`
...
- `cmd/issueops/issueopscli/feedbackcleanup/feedback_cleanup.go`
...
```bash
go test -v ./cmd/issueops/issueopscli -run 'CleanupStatus|CleanupFinish' -count=1
...
- `execution complete` records done/released only after verified draft PR and committed verification report.
