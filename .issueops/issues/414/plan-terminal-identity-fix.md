...
- 이슈: https://github.com/m16khb-org/issueops/issues/414
- lifecycle: `io-b3d92dc6247a`
- branch: `414-terminal-identity-fix`
- base: `main`
...
```bash
issueops execution status --id io-b3d92dc6247a --json
git worktree list
