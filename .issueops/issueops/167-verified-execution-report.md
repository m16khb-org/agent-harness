...
issue: https://github.com/m16khb-org/issueops/issues/167
...
| `cmd/issueops/issueopscli/executioncmd/execution.go` | CLI 서브커맨드 |
...
`cmd/issueops/issueopscli/executioncmd/execution.go:283-285`가 "CLI 전용 표면이고 MCP action
