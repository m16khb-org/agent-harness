...
- Kind: `caution`
- Source: api-doc gate dogfooding against the NestJS microservice fixture in `cmd/issueops/apidoc/dogfood` (2026-08-21)
...
`cmd/issueops/apidoc/dogfood` materializes a two-service NestJS fixture with a
