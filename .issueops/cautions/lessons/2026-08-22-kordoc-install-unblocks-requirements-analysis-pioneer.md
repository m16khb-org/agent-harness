---
name: cautions/lessons/2026-08-22-kordoc-install-unblocks-requirements-analysis-pioneer.md
description: Dated lesson — installing kordoc 4.9.0 and registering it on all three hosts unblocked the requirements-analysis pioneer cases; child tasks need the CLI+handshake probe because they do not inherit host MCP.
---

# 2026-08-22 — Kordoc 설치로 requirements-analysis pioneer 차단 해제

Family index: [CAUTIONS.md](../../CAUTIONS.md).

- Kind: `caution`
- Source: user unblocked the two external dependencies (install Kordoc
  ourselves; GitHub already authenticated). requirements-analysis primary/operational cases
...
- requirements-analysis primary/operational: PASS (증거 매트릭스, 본문↔표 CONFLICT 보존,
