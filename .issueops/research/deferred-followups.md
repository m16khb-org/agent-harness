...
- **근거/결정**: `.issueops/ADR.md` "Defer harness-side tool-error context injection" (+ KILL verdict), 스파이크 `.issueops/research/spike-tool-error-nudge.md`, 커밋 c3e68b6 / 3685ee7.
