...
- Candidate command: `issueops web-fetch benchmark --fixtures testdata/webfetch/live/public-fixtures.json --live --json`
...
- Require `ISSUEOPS_WEBFETCH_LIVE=1`.
...
```bash
ISSUEOPS_WEBFETCH_LIVE=1 ./bin/issueops web-fetch benchmark \
