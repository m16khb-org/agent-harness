...
- Sub-agent research in `.issueops/research/subagent-tradeoffs.md` confirms that context isolation, tool gating, model specialization, fresh review, and parallel independent research can be valuable, but they carry latency/token overhead, summary-only visibility, and weaker mid-run steering.
