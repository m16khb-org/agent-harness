...
- Kind: `adr`
- Source: issueops cycle (branch 12-issueops-planprep-evidence-gate)
...
- Context: 기존 `IssueOpsPlanReadiness`는 intent contract + issue_url만 검사해, 이슈 생성 이전 정보수집(ADR/decision 조회, related-issue scoring, web-research 웹서치)이 권고에만 머물고 강제되지 않았다.
