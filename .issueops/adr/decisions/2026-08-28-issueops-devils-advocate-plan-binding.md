...
- Kind: `adr`
- Source: design-review 실효성 감사(2026-08-28, 트랜스크립트 ~20 사이클·24 라운드 실측) → plan `.issueops/plans/design-review-review-binding.md`, design-review 3라운드 검토
