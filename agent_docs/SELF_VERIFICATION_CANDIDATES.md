...
| 13 | `self-verify-history-retention-budget` | 상태 운영 | 71 | baseline/history가 계속 쌓이면 상태 저장소가 느려지고 오래된 회귀 기준이 혼재된다. | retention policy fixture, prune dry-run/confirm regression, history ordering golden |
