...
- `references/execution-v1.md`: direct/Orca mode selection, sealed owner claim, generation lease, replacement, reconciliation, publication, and completion.
...
Load `references/execution-v1.md` for the full direct/Orca contract and
