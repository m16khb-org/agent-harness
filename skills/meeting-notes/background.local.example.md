# Meeting Notes Local Background

This file is a template for local, non-portable meeting-minutes context. Copy it to `skills/meeting-notes/background.local.md`; the copied file is ignored by git.
