...
Search patterns containing Markdown backticks must be single-quoted or passed as a literal argv, never double-quoted shell text where backticks execute command substitution.
