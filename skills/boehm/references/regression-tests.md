...
```bash
python3 -m py_compile skills/boehm/scripts/*.py
python3 skills/boehm/scripts/render_document_pages.py --help
python3 skills/boehm/scripts/build_image_only_pdf.py --help
python3 skills/boehm/scripts/create_region_crops.py --help
python3 skills/boehm/scripts/validate_analysis_report.py --help
```
...
```bash
python3 scripts/validate-skill.py skills/boehm
python3 /path/to/skill-creator/scripts/quick_validate.py skills/boehm
```
