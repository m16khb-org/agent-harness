// Parnas inspection workflow (Claude Code `Workflow` tool). Pass via `scriptPath`, with
...
//
// Design notes (measured on !5617, 2026-08-28; see .agent-harness/research/llm-code-review-tools-2026-08.md):
...
// (team memory in .agent-harness/parnas/refuted.jsonl; security/data are never suppressed) never reach a skeptic.
const prescreen = (c) => {
