...
Writes one JSON line per refuted candidate to <repo>/.agent-harness/parnas/refuted.jsonl (committed with the
...
def main() -> None:
    ...
    target = repo / ".agent-harness" / "parnas" / "refuted.jsonl"
