...
`<repo>/.issueops/pr-review/refuted.jsonl` (written by `scripts/record_refuted.py`, committed)
...
can promote them into `.kody/rules/*.md` or `.issueops/CAUTIONS.md` (never auto-write them).
