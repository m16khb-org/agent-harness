...
func TestHandleProjectMCPToolCallCoversLocalProjectPayloads(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			call:     MCPToolCall{Name: "project_docs_read", Arguments: map[string]any{"repo": repo, "rel_path": ".issueops/ARCHITECTURE.md"}},
	...
	tests := []struct {
	...
	}{
		{
			...
			call: MCPToolCall{Name: "project_docs_revise", Arguments: map[string]any{
				"repo": repo, "rel_path": ".issueops/ARCHITECTURE.md", "summary": "update",
			}},
...
func TestMCPResourceReadCoversGuidanceStateAndErrors(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{uri: "issueops://project-doc-upkeep", wantType: "text/markdown", wantText: "Project Doc Upkeep Guidance"},
		{uri: "issueops://api-doc-guidance", wantType: "text/markdown", wantText: "API Documentation Guidance"},
		{uri: "issueops://command-policy", wantType: "application/json", wantText: "workspace"},
		{uri: "issueops://state", wantType: "application/json", wantText: "keys"},
		{uri: "issueops://commit-policy", wantType: "text/markdown", wantText: "Conventional"},
