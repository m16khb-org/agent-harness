...
func writeQAGateWrapperFixture(t *testing.T, root string) {
	...
	writeFileForWrapperTest(t, filepath.Join(root, ".issueops", "TESTING.md"), "# Testing\n\n[Unit contracts](testing/unit-and-contract.md)\n")
	writeFileForWrapperTest(t, filepath.Join(root, ".issueops", "testing", "unit-and-contract.md"), "# Unit contracts\n\nWell-structured tests\nPoorly-structured tests\n")
