...
func TestIssueOpsExecutionPrepareCLIAndMCPStatusAndErrorsAreIdentical(t *testing.T) {
	...
	record.Execution.CompletionHistory = []issueopscontract.ExecutionCompletionHistory{{
		Generation: 1,
		Completion: issueopscontract.ExecutionCompletion{Generation: 1, FinalHead: strings.Repeat("a", 40), VerificationReportPath: ".issueops/verified-execution/old.json", Verification: []string{"old verification"}, RemoteArtifactURL: "https://github.com/acme/repo/pull/304", CompletedAt: "2026-08-03T00:00:00Z"},
