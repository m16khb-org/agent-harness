...
func validateHarnessInvariants(root string) StepResult {
	...
	required := []string{
		...
		filepath.Join("internal", "core", "policy_evaluate.go"),
		filepath.Join("internal", "core", "policy_paths.go"),
		filepath.Join("internal", "core", "preflight.go"),
		filepath.Join("internal", "core", "state_io.go"),
		filepath.Join("internal", "core", "state_migrate.go"),
		filepath.Join("internal", "core", "state_types.go"),
