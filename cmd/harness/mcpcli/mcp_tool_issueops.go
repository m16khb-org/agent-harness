...
var issueOpsMCPHandlers = map[string]func(map[string]any) MCPToolOutcome{
	...
	"issueops_reconcile_workspace":            handleMCPIssueOpsReconcileWorkspace,
	...
	"issueops_child_start":                    handleMCPIssueOpsChildStart,
	"issueops_child_status":                   handleMCPIssueOpsChildStatus,
	"issueops_child_accept":                   handleMCPIssueOpsChildAccept,
	"issueops_child_reject":                   handleMCPIssueOpsChildReject,
	"issueops_child_drop":                     handleMCPIssueOpsChildDrop,
	...
	"issueops_handoff":                        handleMCPIssueOpsHandoff,
