...
- Issue: https://github.com/m16khb/agent-harness/issues/222
- Branch: `222-cross-process-child-start-rerun`
- Base: `b4ee1dd881abaa50335af0358e71117961ff7513`
- Canonical worktree: `/Users/m16khb/Workspace/agent-harness.worktrees/222-cross-process-child-start-rerun`
- Owned tracked files:
  - `internal/core/issueops/issueops_delegation_start_process_test.go`
  - `.agent-harness/operations/2026-08-02-issueops-parallel-worktree-child-start.md`
...
- `go test ./internal/core/issueops -run TestStartIssueOpsChildConcurrentSiblingsAcrossProcesses -count=1 -v`
  - PASS: `ok agent-harness/internal/core/issueops 0.690s`
...
- `go test ./internal/core/issueops -run TestStartIssueOpsChildConcurrentSiblingsAcrossProcesses -count=10 -v`
  - PASS: `ok agent-harness/internal/core/issueops 2.544s`
- `go test ./internal/core/issueops -count=1`
  - PASS: `ok agent-harness/internal/core/issueops 82.224s`
