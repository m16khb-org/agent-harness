...
3. 합성 RED 단위 케이스는 **불채택**(brooks: 진짜 RED 3건이 존재하므로 우발 복잡성 — gold-plating 씨앗).
...
- commandKey의 `[`·`(` 접두 절단 보강은 brooks 권고(현재 무해) — 선택 반영.
