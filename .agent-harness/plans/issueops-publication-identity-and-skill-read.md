...
**Interfaces:**
- Consumes: built `bin/agent-harness`, installed native hooks, lifecycle `io-a370d531cf9f`.
...
- [ ] Run focused tests, `go test ./... -count=1`, `go test -race ./... -count=1`, and `go build -o bin/agent-harness ./cmd/harness`.
