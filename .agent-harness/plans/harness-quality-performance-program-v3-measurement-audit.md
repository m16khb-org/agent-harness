...
```bash
zsh -lc 'measure session-start ./bin/agent-harness hook session-start --repo "$PWD" --host codex --json'
```
...
```text
./bin/agent-harness: 17364354 bytes
...
go test ./cmd/harness/hookcli -run 'TestRunHookPostToolUseClearsSuppressedNextActionRelay|TestRunHookStopRelaysSameNextActionChoicesOnlyOnce|TestRunHookPostToolUseEmitsCodexCompatibleNoopJSON' -count=1
```
...
go test ./cmd/harness/selfworkflow/augmentlesson -run TestSaveSelfAugmentLessonPrunesOldLessonRecords -count=1
go test ./internal/core ./internal/core/state ./cmd/harness/selfworkflow/augmentlesson ./cmd/harness/selfworkflow/augmentplan -count=1
```
...
go run ./cmd/harness quality inspect --json
adapter/core/port cmd imports: 0
old remoteparse import: 0
go test ./internal/core/externalllm ./internal/core/issueops ./cmd/harness/selfworkflow/augmentplan ./internal/core/qualitycatalog ./cmd/harness/qualitycli ./internal/adapter/gjc ./cmd/harness/webfetchcli ./cmd/harness/issueopscli/feedbackcleanup ./cmd/harness/mcpcli ./internal/adapter/provider/... ./cmd/harness/issueopscli/remoteverify ./cmd/harness/issueopscli/remotecmd ./internal/core/lifecycle ./cmd/harness/hookcli -count=1
