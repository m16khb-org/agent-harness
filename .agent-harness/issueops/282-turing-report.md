# #282 Turing 리포트 — native hook stable runtime

이슈: https://github.com/m16khb/agent-harness/issues/282
...
```text
go test ./internal/core/install ./internal/adapter/installutil ./internal/adapter/codex ./internal/adapter/claude ./internal/adapter ./cmd/harness/hookcli ./cmd/harness/hookcli/hookcatalog ./cmd/harness/installcli -count=1
```
...
```text
stable binary: /Users/m16khb/Workspace/agent-harness/bin/agent-harness
old inode: 180233675
new inode: 180715415
inode changed: true
...
go vet ./...
go build -o /tmp/agent-harness-282 ./cmd/harness
