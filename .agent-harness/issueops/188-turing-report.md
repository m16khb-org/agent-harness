# #188 Turing 리포트 — usage 카탈로그 단일화

이슈: https://github.com/m16khb/agent-harness/issues/188
...
**레이어가 맞다.** `internal/adapter/cli`는 `fmt`만 import하므로 `cmd/harness/issueopscli`가 그것을
