...
- `go test ./internal/contract/issueops ./internal/contract/issueopslease ./internal/adapter/outbound/issueopspreparation ./internal/application/issueopslease ./internal/core/issueops ./internal/adapter/inbound/issueopspreparation ./internal/adapter/inbound/issueopslease ./internal/adapter/inbound/issueopscompletion ./cmd/harness/harnessapp -count=1`
...
- `go vet ./...`
- `go build -o /tmp/agent-harness-254 ./cmd/harness`
