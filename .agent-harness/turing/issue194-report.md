...
- 이슈: https://github.com/m16khb/agent-harness/issues/194
- PR: https://github.com/m16khb/agent-harness/pull/214
...
```text
TZ=UTC go test ./cmd/harness/daemoncli ./cmd/harness/daemoncli/daemonpaths -count=1
TZ=Asia/Seoul go test ./cmd/harness/daemoncli ./cmd/harness/daemoncli/daemonpaths -count=1
GOOS=linux GOARCH=arm64 CGO_ENABLED=0 go test -c -o /dev/null ./cmd/harness/daemoncli/daemonpaths
```
...
- push run: https://github.com/m16khb/agent-harness/actions/runs/30697449803 — PASS, 7m19s
- pull_request run: https://github.com/m16khb/agent-harness/actions/runs/30697450996 — PASS, 7m08s
