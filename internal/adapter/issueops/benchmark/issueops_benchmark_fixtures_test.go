...
func TestScoreIssueOpsBenchmarkArtifactRequiresPRTypeAndBreakingChangesSections(t *testing.T) {
	fixture := issueopscontract.IssueOpsBenchmarkFixture{ID: "canonical-pr-type-breaking", CriticalFailures: []string{"works in source repo"}}
