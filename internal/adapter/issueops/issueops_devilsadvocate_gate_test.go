...
func TestImplementationReadinessRequiresDevilsAdvocateVerdict(t *testing.T) {
	...
	record.DevilsAdvocateReview = &issueops.IssueOpsDevilsAdvocateReview{Verdict: "pass", RecordedAt: "t"}
	...
	record.DevilsAdvocateReview = &issueops.IssueOpsDevilsAdvocateReview{Verdict: "stop", Findings: []string{"gold-plating"}, RecordedAt: "t"}
