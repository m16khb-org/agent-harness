...
func TestCompareAndApplyCommitsExpectedRawRowsAtomically(t *testing.T) {
	db := openTestDB(t)
	if err := db.Apply(context.Background(), []port.RecordMutation{{Bucket: "resume", ID: "record", Data: []byte("before")}, {Bucket: "resume", ID: "intent", Data: []byte("pending")}}); err != nil {
		t.Fatal(err)
	}
	err := db.CompareAndApply(context.Background(), []port.ExpectedRecord{{Bucket: "resume", ID: "record", Data: []byte("before")}, {Bucket: "resume", ID: "intent", Data: []byte("pending")}}, []port.RecordMutation{{Bucket: "resume", ID: "record", Data: []byte("after")}, {Bucket: "resume", ID: "intent", Delete: true}})
	if err != nil {
		t.Fatal(err)
	}
...
func TestCompareAndApplyRollsBackOnRawMismatch(t *testing.T) {
	...
	err := db.CompareAndApply(context.Background(), []port.ExpectedRecord{{Bucket: "resume", ID: "record", Data: []byte("different")}, {Bucket: "resume", ID: "intent", Data: []byte("pending")}}, []port.RecordMutation{{Bucket: "resume", ID: "record", Data: []byte("after")}, {Bucket: "resume", ID: "intent", Delete: true}})
...
func TestCompareAndApplyFuncSkipsEncoderOnRawMismatch(t *testing.T) {
	db := openTestDB(t)
	if err := db.Apply(context.Background(), []port.RecordMutation{{Bucket: "resume", ID: "record", Data: []byte("before")}}); err != nil {
		t.Fatal(err)
	}
	encoded := false
	err := db.CompareAndApplyFunc(context.Background(), []port.ExpectedRecord{{Bucket: "resume", ID: "record", Data: []byte("different")}}, func() ([]port.RecordMutation, error) {
		encoded = true
		return []port.RecordMutation{{Bucket: "resume", ID: "record", Data: []byte("after")}}, nil
	})
	var stale *RawCASError
