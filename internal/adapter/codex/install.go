	...
	patches := []hookCompatibilityPatch{
		...
		},
		{
			...
			Globs: []string{
				...
				filepath.Join(req.CodexHome, "plugins", "cache", "claude-mem-local", "claude-mem", "*", "scripts", "worker-cli.js"),
				filepath.Join(req.CodexHome, "plugins", "cache", "claude-mem-local", "claude-mem", "*", "hooks", "hooks.json"),
				filepath.Join(req.CodexHome, ".tmp", "marketplaces", "claude-mem-local", "plugin", "scripts", "worker-service.cjs"),
				filepath.Join(req.CodexHome, ".tmp", "marketplaces", "claude-mem-local", "plugin", "scripts", "worker-cli.js"),
				filepath.Join(req.CodexHome, ".tmp", "marketplaces", "claude-mem-local", "plugin", "hooks", "hooks.json"),
				filepath.Join(req.Home, ".claude", "plugins", "cache", "thedotmack", "claude-mem", "*", "scripts", "worker-service.cjs"),
				filepath.Join(req.Home, ".claude", "plugins", "cache", "thedotmack", "claude-mem", "*", "scripts", "worker-cli.js"),
				...
				filepath.Join(req.Home, ".claude", "plugins", "marketplaces", "thedotmack", "plugin", "scripts", "worker-cli.js"),
			...
			Replacements: []textReplacement{
				...
				{Old: "O='{\"continue\": true, \"suppressOutput\": true}'", New: "O='{}'"},
				{Old: "O='{\"continue\":true,\"suppressOutput\":true}'", New: "O='{}'"},
				...
				{Old: "function LMe(t){let e={};return t.continue!==void 0&&(e.continue=t.continue),t.suppressOutput!==void 0&&(e.suppressOutput=t.suppressOutput),t.systemMessage&&(e.systemMessage=t.systemMessage),t.decision===\"block\"&&(e.decision=\"block\"),t.reason&&(e.reason=t.reason),e}", New: "function LMe(t){let e={};return t.continue!==void 0&&(e.continue=t.continue),t.decision===\"block\"&&(e.decision=\"block\"),t.reason&&(e.reason=t.reason),e}"},
