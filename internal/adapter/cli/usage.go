...
Usage:
  ...
  agent-harness self-verify [--full] [--iterations=10] [--seed=N] [--target-score=95] [--progress=none|jsonl] [--llm-eval] [--llm-eval-mode=advisory|gate] [--model MODEL] [--save-state] [--state-key KEY] [--json]
