...
func TestExactReadOnlyShellCommandCorpus(t *testing.T) {
	allow := []string{
		...
		"wc -l /Users/sample/.codex/skills/verification-before-completion/SKILL.md",
		"sed -n '1,240p' /Users/sample/.codex/skills/verification-before-completion/SKILL.md",
	...
	deny := []string{
		...
		"wc -l",
		"wc --files0-from list.txt /Users/sample/.codex/skills/verification-before-completion/SKILL.md",
		"wc -l /Users/sample/.codex/skills/verification-before-completion/SKILL.md && rm -rf /tmp/worker",
		"wc -l /Users/sample/.codex/skills/verification-before-completion/SKILL.md > /tmp/lines",
		"sed -i '' 's/x/y/' /Users/sample/.codex/skills/verification-before-completion/SKILL.md",
		"sed -n 's/x/y/p' /Users/sample/.codex/skills/verification-before-completion/SKILL.md",
...
# file operand still disappears after continuation`,
		"sed -n '1,240p'",
		"sed -n '1,240p' /Users/sample/.codex/skills/verification-before-completion/SKILL.md > /tmp/skill",
		"jq empty",
		"jq empty -",
		"jq empty /dev/stdin",
		"jq empty /dev/fd/0",
