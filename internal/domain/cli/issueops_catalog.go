...
const issueOpsUsageCatalog = `  agent-harness issueops start --repo PATH [--branch NAME] [--json]
  ...
  agent-harness issueops execution prepare --id ID --mode auto|direct|orca --owner-host codex|claude|omo [--owner-model MODEL] [--owner-effort EFFORT] ACTOR_FLAGS [--confirm] [--json]
