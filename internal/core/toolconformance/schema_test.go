...
func TestManifestBaselineClassifierTable(t *testing.T) {
	...
	want := map[string]struct {
		...
		"nested_object_array/valid":                   {true, true, core.ExactValid, []core.Diagnostic{}},
		...
		"nested_object_array/unknown_key":             {true, false, core.UnknownKey, []core.Diagnostic{{Path: "/requireUnique", Code: "unknown_key", Expected: "declared property", Actual: "boolean"}}},
		...
		"nested_object_array/coercible_type_drift":    {false, false, core.CoercibleTypeDrift, []core.Diagnostic{{Path: "/auto_proceed", Code: "wrong_type", Expected: "array", Actual: "string"}}},
		...
		"nested_object_array/noncoercible_type_drift": {false, false, core.NoncoercibleTypeDrift, []core.Diagnostic{{Path: "/subagent_plans", Code: "wrong_type", Expected: "array", Actual: "string"}}},
	}
