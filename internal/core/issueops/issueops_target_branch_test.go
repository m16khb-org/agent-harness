...
func TestStrictPRReadinessFlagsTargetBranchMismatch(t *testing.T) {
	...
	base := IssueOpsRecord{
		...
		BranchPrepare: &IssueOpsBranchPrepare{Provider: "github", IssueURL: "https://github.com/example/repo/issues/1", Branch: "main", BaseBranch: "main", LinkVerified: true},
	}

	mismatch := base
	mismatch.RemoteArtifact = &IssueOpsRemoteArtifactVerification{Provider: "github", Kind: "pr", URL: "https://github.com/example/repo/pull/1", TargetBranch: "develop", VerifiedAt: "2026-06-29T00:00:00Z"}
	...
	match := base
	match.RemoteArtifact = &IssueOpsRemoteArtifactVerification{Provider: "github", Kind: "pr", URL: "https://github.com/example/repo/pull/1", TargetBranch: "main", VerifiedAt: "2026-06-29T00:00:00Z"}
