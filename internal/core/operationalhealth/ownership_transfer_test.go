...
func TestOwnershipCleanupPendingRetainsOperationalAuthority(t *testing.T) {
	cycle := Cycle{ID: "io-owner", Repo: "/tmp/repo", Branch: "1-owner", Phase: "done", HandoffProtocolVersion: 2, HandoffState: "cleanup_pending_human_decision", WorktreePath: "/tmp/repo.worktrees/1-owner", OrcaWorktreeID: "wt-owner"}
